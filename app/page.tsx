...
import { Moon, Sun, Mail, Github, Linkedin, ExternalLink, ChevronLeft, ChevronRight, Smartphone, Briefcase, Code2, Laptop, Globe2, Clock3, Users, Download } from 'lucide-react';
...
const showcaseImages: ShowcaseImage[] = [
  {
    title: 'Kkuljaem App Mobile Preview 1',
    image: '/1.png',
    alt: 'Kkuljaem mobile app preview 1',
  },
  {
    title: 'Kkuljaem App Mobile Preview 2',
    image: '/2.png',
    alt: 'Kkuljaem mobile app preview 2',
  },
  {
    title: 'Kkuljaem App Mobile Preview 3',
    image: '/3.png',
    alt: 'Kkuljaem mobile app preview 3',
  },
  {
    title: 'Kkuljaem App Mobile Preview 4',
    image: '/4.png',
    alt: 'Kkuljaem mobile app preview 4',
  },
  {
    title: 'Kkuljaem App Mobile Preview 5',
    image: '/5.png',
    alt: 'Kkuljaem mobile app preview 5',
  },
  {
    title: 'Kkuljaem App Mobile Preview 6',
    image: '/6.png',
    alt: 'Kkuljaem mobile app preview 6',
  },
  {
    title: 'Kkuljaem App Mobile Preview 7',
    image: '/7.png',
    alt: 'Kkuljaem mobile app preview 7',
  },
  {
    title: 'Kkuljaem App Mobile Preview 8',
    image: '/8.png',
    alt: 'Kkuljaem mobile app preview 8',
  },
  {
    title: 'Kkuljaem App Mobile Preview 9',
    image: '/9.png',
    alt: 'Kkuljaem mobile app preview 9',
  },
];
...
function ThemeButton({ darkMode, onClick }: { darkMode: boolean; onClick: () => void }) {
  return (
    <button
      onClick={onClick}
      type="button"
      className="inline-flex items-center gap-2 rounded-full border border-neutral-300 bg-white px-4 py-2 text-sm font-medium text-neutral-800 transition hover:-translate-y-0.5 hover:cursor-pointer dark:border-neutral-700 dark:bg-neutral-900 dark:text-white"
...
export default function IvanPortfolioWebsite() {
  ...
  const currentShowcase = useMemo(() => {
    return showcaseImages[currentSlide];
  }, [currentSlide]);
  ...
  return (
    <div className="min-h-screen bg-neutral-50 text-neutral-900 transition-colors duration-300 dark:bg-neutral-950 dark:text-white">
      <div className="mx-auto max-w-7xl px-6 py-6 sm:px-8 lg:px-10">
        <header className="sticky top-0 z-30 mb-10 rounded-3xl border border-neutral-200/70 bg-white/85 px-5 py-4 backdrop-blur dark:border-neutral-800 dark:bg-neutral-900/80">
        ...
        <main className="space-y-24 pb-24">
          ...
          <section id="experience" className="space-y-8">
            ...
            <div className="space-y-6">
              {experiences.map((item) => (
                <div key={item.company} className="rounded-[28px] border border-neutral-200 bg-white p-6 shadow-sm dark:border-neutral-800 dark:bg-neutral-900 sm:p-8">
          ...
          <section className="grid gap-8 lg:grid-cols-[0.95fr_1.05fr]">
            ...
            <div className="rounded-[28px] border border-neutral-200 bg-white p-6 shadow-sm dark:border-neutral-800 dark:bg-neutral-900 sm:p-8">
              <SectionTitle eyebrow="Skills" title="Core Stack and Others" description="A practical mix of frontend, backend, mobile, DevOps, and deployment experience." />
          ...
          <section className="rounded-[32px] bg-neutral-900 px-6 py-12 text-white shadow-sm dark:bg-orange-500 sm:px-10">
            <div className="grid gap-8 lg:grid-cols-[1.2fr_0.8fr] lg:items-center">
              <div>
                <p className="text-sm font-semibold uppercase tracking-[0.25em] text-neutral-300 dark:text-orange-100">Let’s build something useful</p>
